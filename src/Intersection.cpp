...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    //Even after vehich is allowed to enter to avoid collision , check for state of traffic light.
    if(!trafficLightIsGreen())
    {
        ...
        //_trafficLight.waitForGreen(); // Another way to wait.
    }
...
{
    //Start traffic light simulation along with intersection simulation.
